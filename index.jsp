...
<title>Student Profile KL University</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Student Name
				- Student Branch - Student ID number</p>
		</div>
	</header>
	<!-- Portfolio Section-->
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/image 1.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 2-->
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/image 2.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 3-->
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/image 31.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 4-->
				<div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/image 4.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 5-->
				<div class="col-md-6 col-lg-4 mb-5 mb-md-0">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/image 5.png"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 6-->
				<div class="col-md-6 col-lg-4">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/image 6.png"
							alt="..." />
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Welcome to Student Profile, the ultimate online solution for assignment submission and grading. We simplify the process for students to submit their work and for educators to grade efficiently.
					</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Our Mission: To enhance education through a user-friendly platform that streamlines assignment management and fosters effective communication. Join us in making learning more accessible and engaging for all!</p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						KL University, Vijayawada <br /> GreenFields, Vaddeswaram, 522502
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Student Profile</h4>
					<p class="lead mb-0">Student Profile is free to Use.And overall theme is created by our Team (Pallavi,Manasvitha).
